...
export DATA_GRAFANA=/mnt/gluster/prod/data/monitor/grafana
export DATA_PROMETHEUS=/mnt/gluster/prod/data/monitor/prometheus
export DATA_ALERTMANAGER=/mnt/gluster/prod/data/monitor/alertmanager
