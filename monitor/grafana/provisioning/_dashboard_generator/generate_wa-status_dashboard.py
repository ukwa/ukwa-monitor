...
def main():
	...
	replace_output_title(outHandle, tmpFl=panelTitle, job='services', title='Services', h=1, w=8, x=0, y=3)
	replace_output_single(outHandle, tmpFl=panelSingle, job='services', title='Up', h=1, w=2, x=0, y=4)
	replace_output_single(outHandle, tmpFl=panelSingle, job='services', title='CPU', h=1, w=2, x=2, y=4)
	replace_output_single(outHandle, tmpFl=panelSingle, job='services', title='Dsk', h=1, w=2, x=4, y=4)
	replace_output_single(outHandle, tmpFl=panelSingle, job='services', title='Mem', h=1, w=2, x=6, y=4)
	...
	replace_output_title(outHandle, tmpFl=panelTitle, job='solr', title='Solr', h=1, w=8, x=16, y=3)
